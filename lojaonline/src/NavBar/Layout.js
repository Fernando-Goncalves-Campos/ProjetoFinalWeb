...
function Layout({user, setUser, logged, setLogged, adm, setAdm, searchItem, setSearchItem}) {
    ...
    return (
        <><div className={theme}>
            <nav id="navBar">
                <svg onClick={()=>navigate("/")} height="80px" width="100px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.00 512.00" fill="#000000" stroke="#000000" stroke-width="0.00512">
